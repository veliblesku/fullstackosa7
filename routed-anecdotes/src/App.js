    ...
    <div>
      <Router>
        <div>
          ...
          <a href='moro' style={padding}>create new</a>
          ...
          <div>
            ...
            <Route exact path="/new" render={() => <CreateNew addNew={props.addNew}/>} />
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Menu anecdotes={anecdotes} anecdoteById={anecdoteById} addNew={addNew}/>
